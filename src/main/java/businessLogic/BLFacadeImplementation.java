	...
	public class BLFacadeImplementation implements BLFacade {
		...
		public ExtendedIterator<String> getDepartingCitiesIterator(){
		    dbManager.open();
		    List<String> cities = dbManager.getDepartCities(); // obtenemos la lista
		    System.out.println("LORTUTAKO HIRIAKKKKKKK: " + cities); 
		    dbManager.close();
		    return new ExtendedIteratorImpl<>(cities); // devolvemos un iterador concreto
		}
		
		public Driver getDriver(String name) {
			dbManager.open();
		    Driver d =dbManager.getDriver(name);
			dbManager.close();
			return d;
		}
